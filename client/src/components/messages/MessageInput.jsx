 ...
 * Calls onSend(text) when the user submits; clears the field afterwards.
 *
...
function MessageInput({ onSend }) {
  ...
  return (
    <div className="shrink-0 border-t border-border-subtle bg-bg-card px-4 py-3">
      <div className="flex items-end gap-2 rounded-2xl border border-border bg-bg-surface px-3 py-2 transition-all duration-150 focus-within:border-secondary-600 focus-within:bg-bg-card focus-within:ring-2 focus-within:ring-secondary-500/20">
        ...
        <button
          ...
          className={[
            ...
            text.trim()
              ...
              : 'bg-navy-100 text-text-muted cursor-not-allowed',
          ].join(' ')}
        >
